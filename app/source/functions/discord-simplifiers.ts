 ...
 */
 ...
 export function gen_embed(headers: string, contents: string | null, footer: EmbedFooterOptions | null, fields: APIEmbedField[], id_color: number | string, URL: string | null, author: EmbedAuthorOptions | null) {
...
/*
 * Function of generating attachments of DiscordJS API formatting.
 =================================================================
 * Attachment builder, occasionaly, requires a buffer that can be get
 * only by reading a file with filing system.
 * 
 * Add-on checks for undefined path, because default inversion doesn't
 * check on undefined in-cased strings.
 */

export async function gen_attach(path: string) {
    ...
    return new discordJS.AttachmentBuilder(buffer);
}