...
import { get_time, out, read_json } from './functions/simplifiers';
import { gen_embed } from './functions/discord-simplifiers';
...
(async () => {
    ...
    setInterval(async () => {
        ...
        const day = weekdays[get_time('days')];
        ...
        switch(day) {
            case 'sunday':
                ...
                APP_SETTINGS['APPLICATIONS_CUR'] = 0;
                break;
            case 'saturday':
